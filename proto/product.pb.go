...
const file_proto_product_proto_rawDesc = "" +
	"\n" +
	"\x13proto/product.proto\x12\aproduct\"O\n" +
	...
	"\x05stock\x18\x04 \x01(\x05R\x05stock\"L\n" +
	...
	"\vDeductStock\x12\x1b.product.DeductStockRequest\x1a\x1c.product.DeductStockResponse\x12E\n" +
	"\n" +
	"GetProduct\x12\x1a.product.GetProductRequest\x1a\x1b.product.GetProductResponse\x12?\n" +
	"\bAddStock\x12\x18.product.AddStockRequest\x1a\x19.product.AddStockResponseB\rZ\v./productpbb\x06proto3"
...
var file_proto_product_proto_goTypes = []any{
	...
	(*AddStockRequest)(nil),     // 4: product.AddStockRequest
	(*AddStockResponse)(nil),    // 5: product.AddStockResponse
}
var file_proto_product_proto_depIdxs = []int32{
	0, // 0: product.ProductService.DeductStock:input_type -> product.DeductStockRequest
	2, // 1: product.ProductService.GetProduct:input_type -> product.GetProductRequest
	4, // 2: product.ProductService.AddStock:input_type -> product.AddStockRequest
	1, // 3: product.ProductService.DeductStock:output_type -> product.DeductStockResponse
	3, // 4: product.ProductService.GetProduct:output_type -> product.GetProductResponse
	5, // 5: product.ProductService.AddStock:output_type -> product.AddStockResponse
